...
public:
    ...
    const boost::asio::ip::tcp::endpoint& rawsocket_ssl_endpoint() const;
    ...
    void set_rawsocket_ssl_endpoint(const std::string& ip_address, uint16_t port);
private:
    bool m_debug;
    std::string m_realm;
    boost::asio::ip::tcp::endpoint m_rawsocket_endpoint;
    boost::asio::ip::tcp::endpoint m_rawsocket_ssl_endpoint;
#ifdef BOOST_ASIO_HAS_LOCAL_SOCKETS
