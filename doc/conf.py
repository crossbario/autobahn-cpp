...
latex_documents = [
  ('index', 'AutobahnCpp.tex', u'AutobahnCpp Documentation',
...
man_pages = [
    ('index', 'autobahncpp', u'AutobahnCpp Documentation',
     [u'Tavendo GmbH'], 1)
]
...
texinfo_documents = [
  ('index', 'AutobahnCpp', u'AutobahnCpp Documentation',
   u'Tavendo GmbH', 'AutobahnCpp', 'open-source implementation of the WAMP protocol for C++',
   'Miscellaneous'),
]
...
# breathe_projects = {
#    "AutobahnCpp": "_doxygen/xml/"
# }

# breathe_default_project = "AutobahnCpp"
